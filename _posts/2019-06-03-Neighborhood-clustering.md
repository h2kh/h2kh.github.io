...
---------
Here is the project [Jupyter notebook.](https://nbviewer.jupyter.org/github/h2kh/Hong-Kong-neighborhood-clustering/blob/master/Hong%20Kong%20neighborhoods.ipynb) Read on for a brief summary of the project.
