...
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/map1.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture1.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture3.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture2.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture5.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture6.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/map2.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture7.JPG)
{: refdef}
...
{:refdef: style="text-align: center;"}
![Dashboard snapshot]({{ site.baseimg }}/assets/Capture8.JPG)
{: refdef}
